    ...
    updateAttribute(unavailable = true, disable = true){
        ...
        if(unavailable){
            ...
            if (disable) {
                ...
                productPrice = price;
                productPrice = Shopify.formatMoney(productPrice, window.money_format);
                productPrice = extractContent(productPrice);
                console.log("productPrice", productPrice)
                $('[data-product-quickview-handle] .price').removeClass("price--on-sale"); 
                $('[data-product-quickview-handle] .price__last .price-item ').html(productPrice); 
